pdf("sketch14.pdf", width=8, height=2.5)
par(mar=c(5,3,1,1))
...
plot(xs, ys, 'l',xlim = c(-3,3), ylim = c(0,0.4**0.8),
...
polygon(c(xs[xs>=zhi], 3, zhi),c(ys[xs>=zhi], 0, 0), col=rgb(1,0,0,0.5))
polygon(c(xs[xs<=zlo], zlo, -3),c(ys[xs<=zlo], 0, 0), col=rgb(1,0,0,0.5))
