pdf("sketch11.pdf", width=6, height=2.5)
par(mar=c(5,3,1,1))
...
polygon(c(xs[xs<=-1.95], -1.95, -3),c(ys[xs<=-1.95], 0, 0), col=rgb(1,0,0,0.5))
polygon(c(xs[xs>=1.95], 3, 1.95),c(ys[xs>=1.95], 0, 0), col=rgb(1,0,0,0.5))
