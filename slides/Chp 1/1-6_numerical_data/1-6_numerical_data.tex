...
\begin{frame}
\frametitle{Alternative formula for mean}
...
\item This same formula can be written as
\[ \bar{x} = \frac{\sum_{i=1}^n x_i}{n} \]

where $\sum_{i=1}^n$ means ``sum as $i$ increments from 1 to $n$''.
...
$\:$
\onslide<3->{
\[ s^2 = \frac{(5 - 6.71)^2 + (9 - 6.71)^2 + \cdots + (7 - 6.71)^2}{217 - 1} = 4.11~{\rm hours}^2 \]
}
...
\begin{center}
\includegraphics[width=0.4\textwidth]{1-6_numerical_data/figures/basket_games/basket_games_hist}
\includegraphics[width=0.4\textwidth]{1-6_numerical_data/figures/basket_games/basket_games_hist_log}
\end{center}
