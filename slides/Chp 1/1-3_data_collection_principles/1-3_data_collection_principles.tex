...
\item Over the last 5 years, what is the average time to complete a degree for BHCC students?
\item Does a new drug reduce the number of deaths in patients with severe heart disease?
\end{enumerate}
Each question is about a {\bf population}, but a researcher would probably need to use a {\bf sample}. 
\end{frame}
...
\item I met two students who took more than 7 years to graduate from BHCC, so it must take a long time to graduate.
\item My friend's dad had a heart attack and died after they gave him a new heart disease drug, so the drug must not work.
\end{enumerate}
\pause
...
\ct{\webURL{https://www.census.gov/data/datasets/2010/dec/2010-participation-rates.html}}
