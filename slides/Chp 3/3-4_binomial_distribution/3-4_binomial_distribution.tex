...
\begin{figure}
    \begin{overprint}
    \onslide<1>\centering\includegraphics[scale=0.3]{3-4_binomial_distribution/figures/stars/dots_7.pdf}
    \onslide<2| handout:0>\centering\includegraphics[scale=0.3]{3-4_binomial_distribution/figures/stars/dots_7_solution.pdf}
    \end{overprint}
\end{figure}
